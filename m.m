...
(def desugar-quote' (fix (fn desugar-quote' (fn name ((((nil? name) (fn _ name)) (fn _ (((((char.= quote) (car name)) (fn _ ((cons quote) ((cons quote) (desugar-quote' (cdr name)))))) (fn _ ((cons (car name)) (desugar-quote' (cdr name))))) ()))) ())))))
...
(def desugar-quote (fn name (((((or (desugar-should-quote? name)) (fn _ (nil? name))) (fn _ ((cons quote) (((swap append) quote) (desugar-quote' name))))) (fn _ name)) ())))
