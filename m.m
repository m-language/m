...
(def match-symbol-literal-expr (fn exprs (fn no-symbol (fn invalid-symbol (fn success ((((nil? exprs) (fn _ no-symbol)) (fn _ (((car exprs) (fn name (fn _ (fn _ (fn _ (success name)))))) (fn _ (fn _ (fn _ (fn _ (invalid-symbol (car exprs))))))))) nil))))))
