...
(def match-def-expr (fn exprs (fn no-name (fn no-expr (fn extra-exprs (fn invalid-name (fn success ((((nil? exprs) (fn _ no-name)) (fn _ ((((nil? (cdr exprs)) (fn _ no-expr)) (fn _ ((((not (nil? (cddr exprs))) (fn _ extra-exprs)) (fn _ (((car exprs) (fn name (fn _ (fn _ (fn _ ((success name) (cadr exprs))))))) (fn _ (fn _ (fn _ (fn _ (invalid-name (car exprs))))))))) nil))) nil))) nil))))))))
(def match-macro-expr match-def-expr)
(def match-symbol-literal-expr (fn exprs (fn no-symbol (fn extra-exprs (fn invalid-symbol (fn success ((((nil? exprs) (fn _ no-symbol)) (fn _ ((((not (nil? (cdr exprs))) (fn _ extra-exprs)) (fn _ (((car exprs) (fn name (fn _ (fn _ (fn _ (success name)))))) (fn _ (fn _ (fn _ (fn _ (invalid-symbol (car exprs))))))))) nil))) nil)))))))
