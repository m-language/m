...
(def combine-parser
  (lambda parser1 parser2 input state
...
(def is-identifier-expr
  (lambda expr
    (eq-keyword (type-name expr) (keyword identifier-expr))))
...
(def is-list-expr
  (lambda expr
    (eq-keyword (type-name expr) (keyword list-expr))))
