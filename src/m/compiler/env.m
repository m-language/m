...
(defn local-env.with-locals locals e (local-env locals (local-env.def e)))
(defn local-env.with-def def e (local-env (local-env.locals e) def))

;; The global environment.
(def global-env
  (new-data (symbol global-env)
    (list (symbol globals) (symbol heap) (symbol dependents))))
...
(defn global-env.with-globals globals e (global-env globals (global-env.heap e) (global-env.dependents e)))
(defn global-env.with-heap heap e (global-env (global-env.globals e) heap (global-env.dependents e)))
(defn global-env.with-dependents dependents e (global-env (global-env.globals e) (global-env.heap e) dependents))
...
(def default-global-env
  (global-env (empty-tree-map compare-symbol) heap/nil (empty-tree-map compare-symbol)))
