...
(def generate-macro-apply-expr (fn generate-expr (fn expr (fn name (fn args (fn local-env (fn global-env ((with ((heap.get (global-env.heap global-env)) name)) (fn function (((generate-expr ((((list-expr ((map (debug (function (debug ((map args) expr->list))))) list->expr)) (identifier-expr.path expr)) (identifier-expr.start expr)) (identifier-expr.end expr))) local-env) global-env))))))))))
