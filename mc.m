...
(def symbol-expr0 (fn name ((((symbol-expr name) (symbol expr.m)) start-position) start-position)))
(def list-expr0 (fn exprs ((((list-expr exprs) (symbol expr.m)) start-position) start-position)))
(def expr/symbol (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol symbol-expr0))) ((cons (car exprs)) ()))))))
(def expr/list (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol list-expr0))) ((cons (car exprs)) ()))))))
(def delay (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol fn))) ((cons (symbol-expr0 (symbol _))) exprs))))))
(def list (fn env (fn exprs (list-expr0 ((((nil? exprs) (const ())) (fn _ ((cons (symbol-expr0 (symbol cons))) ((cons (car exprs)) ((cons (((id list) env) (cdr exprs))) ()))))) ())))))
(def success (left ()))
(def mc:test (fn _ success))
(def apply-vararg (fn env (fn exprs (list-expr0 ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol list))) (cdr exprs)))) ()))))))
(def if (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol force))) ((cons (list-expr0 ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol delay))) ((cons (cadr exprs)) ())))) ((cons (list-expr0 ((cons (symbol-expr0 (symbol delay))) ((cons (caddr exprs)) ())))) ()))))) ()))))))
(def macrofn (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol macro))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol fn))) (cdr exprs)))) ())))))))
(def & (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol and))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol delay))) ((cons (cadr exprs)) ())))) ())))))))
(def | (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol or))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol delay))) ((cons (cadr exprs)) ())))) ())))))))
(def defn (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol def))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol fn))) (cdr exprs)))) ())))))))
...
(def extern (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol def))) ((cons (car exprs)) ((cons (car exprs)) ())))))))
...
(def assert (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol delay))) ((cons (list-expr0 ((cons (symbol-expr0 (symbol test-condition))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol symbol))) ((cons (symbol-expr0 (symbol ""Assertion failed""))) ())))) ()))))) ()))))))
(def assert-not (fn env (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol assert))) ((cons (list-expr0 ((cons (symbol-expr0 (symbol not))) ((cons (car exprs)) ())))) ()))))))
(def force (fn env (fn exprs (list-expr0 ((cons (car exprs)) ((cons (list-expr0 ())) ()))))))
...
(def do (fn env (fn exprs ((((nil? (cdr exprs)) (fn _ (list-expr0 exprs))) (fn _ (list-expr0 ((cons (symbol-expr0 (symbol then-run-with))) ((cons (cadr exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol fn))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol do))) (cddr exprs)))) ()))))) ())))))) ()))))
(def symbol->list id)
...
(def stdin stdin)
(def debug debug)
(def let (fn env (fn exprs ((((nil? (cdr exprs)) (fn _ (list-expr0 exprs))) (fn _ (list-expr0 ((cons (symbol-expr0 (symbol with))) ((cons (cadr exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol fn))) ((cons (car exprs)) ((cons (list-expr0 ((cons (symbol-expr0 (symbol let))) (cddr exprs)))) ()))))) ())))))) ()))))
...
(def generate-macro-apply-expr (fn generate-expr (fn expr (fn name (fn args (fn local-env (fn global-env ((with ((heap.get (global-env.heap global-env)) name)) (fn function ((with (global-env->env global-env)) (fn env (((generate-expr ((expr.with-path (expr.path expr)) ((function env) args))) local-env) global-env))))))))))))
