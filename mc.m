...
(def macrofn (fn expr (expr.list ((cons (expr.symbol (symbol macro))) ((cons (car expr)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) (cdr expr)))) ()))))))
...
(def defn (fn expr (expr.list ((cons (expr.symbol (symbol def))) ((cons (car expr)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) (cdr expr)))) ()))))))
...
(def let (fn expr ((((nil? (cdr expr)) (fn _ (expr.list expr))) (fn _ (expr.list ((cons (expr.symbol (symbol with))) ((cons (cadr expr)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) ((cons (car expr)) ((cons (expr.list ((cons (expr.symbol (symbol let))) (cddr expr)))) ()))))) ())))))) ())))
...
(def do (fn expr ((((nil? (cdr expr)) (fn _ (expr.list expr))) (fn _ (expr.list ((cons (expr.symbol (symbol then-run-with))) ((cons (cadr expr)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) ((cons (car expr)) ((cons (expr.list ((cons (expr.symbol (symbol do))) (cddr expr)))) ()))))) ())))))) ())))
(def symbol->list id)
...
(def compile (fn backend (fn in (fn out ((then-run-with (parse-file in)) (fn exprs ((then-run-with (generate exprs)) (fn result (((write-result backend) result) out)))))))))
(def mpm-put (fn in ((then-run-with (parse-file in)) (fn exprs ((then-run-with (generate exprs)) (fn result ((then-run (mpm-put-refs (generated.declarations result))) (mpm-put-srcs in))))))))
...
(def """" (fn args ((with ((file.child file.local-file) (car args))) (fn file ((then-run-with (parse-file file)) (fn exprs ((then-run-with (generate exprs)) (fn result ((((repl (generated.global-env result)) ((interpret-declarations (generated.declarations result)) empty-heap)) nat.1) (empty-tree-map compare-symbol))))))))))
