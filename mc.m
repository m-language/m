...
(def istream.read id)
(def delay (fn expr ((cons (left (symbol fn))) ((cons (left (symbol _))) expr))))
...
(def append (fn list (fn elem ((((nil? list) (fn _ (list1 elem))) (fn _ ((cons (car list)) ((append (cdr list)) elem)))) ()))))
...
(def generate-exprs' (fn exprs (fn result ((((nil? exprs) (fn _ result)) (fn _ ((with (((generate-expr (car exprs)) default-local-env) (generate-result.global-env result))) (fn car-result ((generate-exprs' (cdr exprs)) ((((generate-result.combine result) car-result) (generate-result.global-env car-result)) true)))))) ()))))
