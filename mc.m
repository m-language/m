...
(def char:test (combine-tests ((cons (fn _ ((test-condition (not ((char.= linefeed) carriage-return))) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (newline? linefeed)) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (newline? carriage-return)) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (whitespace? space)) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (whitespace? tab)) (symbol ""Assertion failed"")))) ())))))))
