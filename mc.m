...
(def lazy:test (combine-tests ((cons (fn _ ((test-condition ((fn _ true) ())) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (not ((fn _ false) ()))) (symbol ""Assertion failed"")))) ()))))
(def nat:test (combine-tests ((cons (fn _ ((test-condition (nat.0? nat.0)) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (not (nat.0? nat.1))) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (nat.0? (nat.dec nat.1))) (symbol ""Assertion failed"")))) ((cons (fn _ ((test-condition (not (nat.0? (nat.inc nat.0)))) (symbol ""Assertion failed"")))) ((cons (((test-compare compare-nat) nat.0) nat.1)) ())))))))
(def mc:test (combine-tests ((cons bool:test) ((cons char:test) ((cons either:test) ((cons lazy:test) ((cons nat:test) ())))))))
