...
(def & (fn expr (((list3 (left (symbol and))) (car expr)) (right ((cons (left (symbol delay))) (list1 (cadr expr)))))))
(def | (fn expr (((list3 (left (symbol or))) (car expr)) (right ((cons (left (symbol delay))) (list1 (cadr expr)))))))
(def if (fn expr ((list2 (left (symbol force))) (right (((list3 (car expr)) (right ((cons (left (symbol delay))) (list1 (cadr expr))))) (right ((cons (left (symbol delay))) (list1 (caddr expr)))))))))
...
(def istream.read id)
(def delay (fn expr ((cons (left (symbol fn))) ((cons (left (symbol """"))) expr))))
(def force (fn expr ((cons (car expr)) (list1 (right ())))))
...
(def init (fn list ((((nil? (cdr list)) (fn """" ())) (fn """" ((cons (car list)) (init (cdr list))))) ())))
(def last (fn list ((((nil? (cdr list)) (fn """" (car list))) (fn """" (last (cdr list)))) ())))
(def append (fn list (fn elem ((((nil? list) (fn """" (list1 elem))) (fn """" ((cons (car list)) ((append (cdr list)) elem)))) ()))))
(def concat (fn a (fn b ((((nil? a) (fn """" b)) (fn """" ((cons (car a)) ((concat (cdr a)) b)))) ()))))
(def symbol.+ concat)
...
(def list.= (fn f (fn a (fn b ((((nil? a) (fn """" (nil? b))) (fn """" ((((nil? b) (fn """" false)) (fn """" ((and ((f (car a)) (car b))) (fn """" (((list.= f) (cdr a)) (cdr b)))))) ()))) ())))))
(def char->nat id)
...
(def nat.+ (fn a (fn b ((((nat.0? b) (fn """" a)) (fn """" ((nat.+ (nat.inc a)) (nat.dec b)))) ()))))
(def nat.- (fn a (fn b ((((nat.0? b) (fn """" a)) (fn """" ((nat.- (nat.dec a)) (nat.dec b)))) ()))))
(def nat.< (fn a (fn b ((((nat.0? a) (fn """" (not (nat.0? b)))) (fn """" ((((nat.0? b) (fn """" false)) (fn """" ((nat.< (nat.dec a)) (nat.dec b)))) ()))) ()))))
(def nat.> (swap nat.<))
(def nat.= (fn a (fn b ((((nat.0? a) (fn """" (nat.0? b))) (fn """" ((((nat.0? b) (fn """" false)) (fn """" ((nat.= (nat.dec a)) (nat.dec b)))) ()))) ()))))
(def char.= nat.=)
...
(def desugar-quote (fn name (((((or (desugar-should-quote? name)) (fn """" (nil? name))) (fn """" ((cons quote) ((cons quote) (((swap append) quote) (((swap append) quote) name)))))) (fn """" name)) ())))
...
(def compare-list (fn compare (fn a (fn b (((((and (nil? a)) (fn """" (nil? b))) (fn """" compare=)) (fn """" ((((nil? a) (fn """" compare<)) (fn """" ((((nil? b) (fn """" compare>)) (fn """" ((with ((compare (car a)) (car b))) (fn compare-result ((((compare=? compare-result) (fn """" (((compare-list compare) (cdr a)) (cdr b)))) (fn """" compare-result)) ()))))) ()))) ()))) ())))))
(def compare-nat (fn a (fn b (((((nat.> a) b) (fn """" compare>)) (fn """" (((((nat.< a) b) (fn """" compare<)) (fn """" compare=)) ()))) ()))))
...
(def interpret-fn-declaration (fn declaration (fn heap (fn name (((((symbol.= name) (fn-declaration.name declaration)) (fn """" (some (fn heap' (fn stack (((interpret-operation' (fn-declaration.value declaration)) stack) heap')))))) (fn """" (heap name))) ())))))
(def interpret-declaration (fn declaration (fn heap (((((with (type-name declaration)) (fn type (((((symbol.= type) (symbol def-declaration)) (fn """" interpret-def-declaration)) (fn """" (((((symbol.= type) (symbol fn-declaration)) (fn """" interpret-fn-declaration)) (fn """" (error (symbol ...)))) ()))) ()))) (type-name declaration)) declaration) heap))))
...
(def parse-single-quote (fn input (fn path (fn start (fn end (fn acc ((with (car input)) (fn head (((((char.= head) quote) (fn """" ((parse-result (cdr input)) ((((identifier-expr (reverse acc)) path) start) (next-char end))))) (fn """" ((((newline? head) (fn """" (((((parse-single-quote (cdr input)) path) start) (next-line end)) ((cons head) acc)))) (fn """" (((((parse-single-quote (cdr input)) path) start) (next-char end)) ((cons head) acc)))) ()))) ())))))))))
(def parse-double-quote (fn input (fn path (fn start (fn end (fn acc ((with (car input)) (fn head (((((char.= head) quote) (fn """" (((((char.= (cadr input)) quote) (fn """" ((parse-result (cddr input)) ((((identifier-expr (reverse acc)) path) start) (next-char (next-char end)))))) (fn """" (((((parse-double-quote (cdr input)) path) start) (next-char end)) ((cons quote) acc)))) ()))) (fn """" ((((newline? head) (fn """" (((((parse-double-quote (cdr input)) path) start) (next-line end)) ((cons head) acc)))) (fn """" (((((parse-double-quote (cdr input)) path) start) (next-char end)) ((cons head) acc)))) ()))) ())))))))))
(def parse-identifier-literal-expr (fn input (fn path (fn start (fn end (fn acc (((((char.= (car input)) quote) (fn """" (((((parse-double-quote (cdr input)) path) start) (next-char end)) acc))) (fn """" (((((parse-single-quote input) path) start) end) acc))) ())))))))
...
(def mpm-resolve-dependencies (fn resolve (fn resolved (fn result (fn dependencies (fn indef ((((nil? dependencies) (fn """" ((with (((indef (fn """" result)) (fn """" ((degenerate ((symbol.+ (symbol ""Could not find "")) ((flat-map dependencies) ((swap append) space)))) (generate-result.global-env result)))) ())) (fn result (impure ((pair resolved) result)))))) (fn """" ((with (mpm-get-ref (car dependencies))) (fn ref-file ((then-run-with (file.exists? ref-file)) (fn is-ref ((((not is-ref) (fn """" (((((mpm-resolve-dependencies resolve) resolved) result) (cdr dependencies)) indef))) (fn """" ((then-run-with (file.read ref-file)) (fn ref ((((some? ((tree-map.get resolved) ref)) (fn """" (((((mpm-resolve-dependencies resolve) resolved) result) (cdr dependencies)) true))) (fn """" ((then-run-with (((parse-file (mpm-get-src ref)) ()) true)) (fn exprs ((then-run-with ((resolve (((tree-map.put resolved) ref) true)) ((generate-exprs' exprs) result))) (fn pair (((((mpm-resolve-dependencies resolve) (first pair)) (second pair)) (cdr dependencies)) true))))))) ()))))) ()))))))) ())))))))
