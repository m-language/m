...
(def expr/symbol (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol symbol-expr0))) ((cons (car exprs)) ())))))
(def expr/list (fn exprs (list-expr0 ((cons (symbol-expr0 (symbol list-expr0))) ((cons (car exprs)) ())))))
