...
(def nil ())
(def cons pair)
(def delay (fn exprs (expr.list ((cons (expr.symbol (symbol fn))) ((cons (expr.symbol (symbol _))) exprs)))))
(def car first)
(def cdr second)
...
(def list (fn exprs (expr.list ((((nil? exprs) (const ())) (fn _ ((cons (expr.symbol (symbol cons))) ((cons (car exprs)) ((cons ((id list) (cdr exprs))) ()))))) ()))))
(def success (left ()))
(def mc:test (fn _ success))
(def apply-vararg (fn exprs (expr.list ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol list))) (cdr exprs)))) ())))))
(def if (fn exprs (expr.list ((cons (expr.symbol (symbol force))) ((cons (expr.list ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol delay))) ((cons (cadr exprs)) ())))) ((cons (expr.list ((cons (expr.symbol (symbol delay))) ((cons (caddr exprs)) ())))) ()))))) ())))))
(def macrofn (fn exprs (expr.list ((cons (expr.symbol (symbol macro))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) (cdr exprs)))) ()))))))
(def & (fn exprs (expr.list ((cons (expr.symbol (symbol and))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol delay))) ((cons (cadr exprs)) ())))) ()))))))
(def | (fn exprs (expr.list ((cons (expr.symbol (symbol or))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol delay))) ((cons (cadr exprs)) ())))) ()))))))
(def defn (fn exprs (expr.list ((cons (expr.symbol (symbol def))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) (cdr exprs)))) ()))))))
...
(def extern (fn exprs (expr.list ((cons (expr.symbol (symbol def))) ((cons (car exprs)) ((cons (car exprs)) ()))))))
...
(def assert (fn exprs (expr.list ((cons (expr.symbol (symbol delay))) ((cons (expr.list ((cons (expr.symbol (symbol test-condition))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol symbol))) ((cons (expr.symbol (symbol ""Assertion failed""))) ())))) ()))))) ())))))
(def assert-not (fn exprs (expr.list ((cons (expr.symbol (symbol assert))) ((cons (expr.list ((cons (expr.symbol (symbol not))) ((cons (car exprs)) ())))) ())))))
(def force (fn exprs (expr.list ((cons (car exprs)) ((cons (right ())) ())))))
...
(def let (fn exprs ((((nil? (cdr exprs)) (fn _ (expr.list exprs))) (fn _ (expr.list ((cons (expr.symbol (symbol with))) ((cons (cadr exprs)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol let))) (cddr exprs)))) ()))))) ())))))) ())))
...
(def do (fn exprs ((((nil? (cdr exprs)) (fn _ (expr.list exprs))) (fn _ (expr.list ((cons (expr.symbol (symbol then-run-with))) ((cons (cadr exprs)) ((cons (expr.list ((cons (expr.symbol (symbol fn))) ((cons (car exprs)) ((cons (expr.list ((cons (expr.symbol (symbol do))) (cddr exprs)))) ()))))) ())))))) ())))
(def symbol->list id)
...
(def symbol-expr ((new-data (symbol symbol-expr)) ((cons (symbol name)) ((cons (symbol path)) ((cons (symbol start)) ((cons (symbol end)) ()))))))
...
(def expr->list (fn expr ((((symbol-expr? expr) (fn _ (left (symbol-expr.name expr)))) (fn _ (right ((map (list-expr.exprs expr)) expr->list)))) ())))
...
(def list->expr (fn expr (fn either ((either (fn name ((((symbol-expr name) (expr.path expr)) (expr.start expr)) (expr.end expr)))) (fn list ((((list-expr ((map list) (list->expr expr))) (expr.path expr)) (expr.start expr)) (expr.end expr)))))))
