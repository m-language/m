...
(def cond-satisfy (fn env (fn exprs ((((nil? exprs) (fn _ (result/error (symbol ""No exprs passed to cond-satisfy"")))) (fn _ ((with (car exprs)) (fn predicate ((with (cdr exprs)) (fn vals ((((nil? vals) (fn _ (result/error (symbol ""No values after predicate for cond-satisfy"")))) (fn _ ((((nil? (cdr vals)) (fn _ (result/success (car vals)))) (fn _ (result/success (expr/list ((cons (expr/symbol (symbol if))) ((cons (expr/list ((cons predicate) ((cons (car vals)) ())))) ((cons (cadr vals)) ((cons (expr/list ((cons (expr/symbol (symbol cond-satisfy))) ((cons predicate) (cddr vals))))) ())))))))) ()))) ()))))))) ()))))
